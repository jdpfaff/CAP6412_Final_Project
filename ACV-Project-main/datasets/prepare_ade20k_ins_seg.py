...
if __name__ == "__main__":
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        instance_dir = f"/home/cap6412.student21/ACV-Project-main/datasets/ADEChallengeData2016/images/{dirname}/"
        # img_id = 0
        ann_id = 1
        ...
        category_dict = [{'id': 1, 'name': 'nucleus'}]


        # filenames = sorted(glob.glob(os.path.join(image_dir, "*.jpg")))
        filenames = sorted((glob.glob(f"/home/cap6412.student21/ACV-Project-main/datasets/ADEChallengeData2016/images/{dirname}/*Nuclei.jpg")))
        ...
        for idx, filename in enumerate(tqdm.tqdm(filenames)):
            ...
            ins_seg = tifffile.imread(filename_instance)
            # assert ins_seg.dtype == np.uint8
            ins_segC = ins_seg.copy()
            ins_segC[ins_segC > 0] = 1
            instance_cat_ids = ins_segC
            # instance id starts from 1!
            # because 0 is reserved as VOID label
            instance_ins_ids = ins_seg
